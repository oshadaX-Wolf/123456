...
cima.sendMessage("6289675733552@s.whatsapp.net", {text: teksnotif})
console.log(chalk.cyan.bold('Bot Berhasil Tersambung Buy Kebutuhan Hosting Ke Ipennz Ajaa Mas/Mba 6289675733552'))
}
})
...
let fill = [global.owner, "6289675733552"]
